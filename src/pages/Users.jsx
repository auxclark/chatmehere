...
const Users = () => {
  ...
  // Open profile — prefill name fields with current values
  ...
  const handleProfileImageChange = (e) => {
    ...
    if (!allowed.includes(file.type)) {
      setProfileError("Please upload a jpeg, jpg, or png file.");
      return;
    }
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .messenger-sidebar {
          ...
          border-right: 1px solid #e8edf2; display: flex;
        ...
        .sidebar-logout-btn {
          width: 38px; height: 38px; border-radius: 10px;
          border: none; background: #fff5f5; color: #89253E;
        ...
        .sidebar-me-edit-hint {
          position: absolute; right: 14px; top: 50%; transform: translateY(-50%);
          font-size: 11px; color: #89253E; font-weight: 600;
        ...
        .sidebar-search-input {
          ...
          font-size: 13px; outline: none; background: #f8fafc; color: #2d3748;
        ...
        .sidebar-list-label {
          ...
          padding: 10px 10px 6px; display: flex; align-items: center; gap: 6px;
        }
        ...
        .sidebar-user-item {
          ...
          transition: background 0.15s; margin-bottom: 2px; border-left: 3px solid transparent;
        }
        ...
        .profile-overlay {
          ...
          display: flex; align-items: center; justify-content: center;
          padding: 20px; animation: profileFadeIn 0.2s ease forwards;
        }
        .profile-modal {
          background: #fff; border-radius: 24px;
          width: 100%; max-width: 460px;
          box-shadow: 0 24px 80px rgba(0,0,0,0.25);
          animation: profileSlideUp 0.3s ease forwards;
        ...
        .profile-modal-header {
          background: linear-gradient(135deg, #89253E, #3A6186);
          padding: 28px 28px 64px; position: relative; text-align: center;
        }
        .profile-modal-close {
        ...
        .profile-avatar-section {
          ...
          margin-top: -52px; padding: 0 28px 20px; position: relative;
        }
        ...
        .profile-input {
          height: 44px; width: 100%; font-size: 14px;
        ...
        .profile-save-name-btn {
          ...
          box-shadow: 0 3px 12px rgba(137,37,62,0.25);
        }
        ...
        @media (max-width: 768px) {
          ...
          .messenger-chat-area.hidden { display: none; }
          ...
          <div className="sidebar-header">
            ...
            <div className="sidebar-current-user" onClick={handleOpenProfile} title="Edit profile">
              <div className="sidebar-me-avatar-wrap">
                <img
                  src={user?.avatar || `https://ui-avatars.com/api/?name=${user?.firstName}+${user?.lastName}&background=89253E&color=fff`}
                  alt={user?.firstName} className="sidebar-me-avatar"
                />
              ...
              <div className="sidebar-me-edit-hint">
            ...
            <div className="sidebar-search-wrap">
              ...
              />
              {searchTerm && (
                <i className="fa-solid fa-xmark sidebar-search-clear" onClick={() => setSearchTerm("")} />
              )}
            </div>
          </div>
              ...
              users.map((u) => (
                ...
                >
                  <div className="sidebar-user-avatar-wrap">
                    <img
                      src={u.avatar || `https://ui-avatars.com/api/?name=${u.firstName}+${u.lastName}&background=3A6186&color=fff`}
                      alt={u.firstName} className="sidebar-user-avatar"
                    />
            ...
            <div className="profile-modal">
              ...
              <div className="profile-avatar-section">
                <div className="profile-avatar-wrap">
                  <img
                    src={profilePreview || user?.avatar || `https://ui-avatars.com/api/?name=${user?.firstName}+${user?.lastName}&background=89253E&color=fff&size=200`}
                    alt="avatar" className="profile-avatar"
                  />
                  <label className="profile-avatar-edit-btn" htmlFor="profile-avatar-input" title="Change photo">
                    <i className="fa-solid fa-camera"></i>
                  </label>
                  <input
                    id="profile-avatar-input" type="file"
              ...
              <div className="profile-section">
                <div className="profile-section-label">
                  <i className="fa-solid fa-user-pen"></i> Edit Name
                </div>
                <div className="profile-name-row">
                  <div className="profile-field">
                    ...
                    <input
                      ...
                      onChange={e => { setFirstName(e.target.value); setNameError(""); setNameSuccess(""); }}
                  ...
                  <div className="profile-field">
                    ...
                    <input
                      ...
                      onChange={e => { setLastName(e.target.value); setNameError(""); setNameSuccess(""); }}
                ...
                >
                  {nameLoading
                    ...
                    : <><i className="fa-solid fa-floppy-disk"></i> Save Name</>
                  }
                </button>
              </div>
              ...
              <div className="profile-section">
                ...
                <div className="profile-preview-box">
                  <label htmlFor="profile-avatar-input">
                    {profilePreview ? (
                      <>
                        <img src={profilePreview} alt="preview" className="profile-preview-img" />
                        <span style={{ fontSize: 13, color: '#89253E', fontWeight: 600 }}>
                          <i className="fa-solid fa-check" style={{ marginRight: 6 }}></i>
                          Photo selected — click Save Photo to upload
                        </span>
                      </>
                    ) : (
                ...
                <button
                  ...
                  disabled={!profileImage || profileLoading}
                >
                  {profileLoading
                    ? <><i className="fa-solid fa-spinner fa-spin"></i> Uploading...</>
                    : <><i className="fa-solid fa-cloud-arrow-up"></i> Save Photo</>
                  }
                </button>
              </div>
              ...
              <div className="profile-close-row">
                <button className="profile-close-btn" onClick={handleCloseProfile}>
                  <i className="fa-solid fa-xmark" style={{ marginRight: 8 }}></i> Close
                </button>
              </div>
